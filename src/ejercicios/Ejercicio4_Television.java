public class Ejercicio4_Television extends Ejercicio4_Electrodomestico {

    private int resolucion;
    private boolean sintonizadorTDT;

    // Constructor con precio y peso
    public Ejercicio4_Television(double precioBase, double peso) {
    ...
    public Ejercicio4_Television(double precioBase, String color, char consumoEnergetico,
